...
public class InvoiceController {
    ...
    @GetMapping("/list-all/{driverId}")
    public ResponseEntity<List<InvoiceDTO>> listAllInvoicesByDriverId(@PathVariable String driverId) {
        return ResponseEntity.ok(invoiceService.findAllByDriverId(driverId));
    }
}
